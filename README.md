...
## Process for importing data from Nutrient Database:

### Main page to retrieve data:

* Main page (Release 28): https://www.ars.usda.gov/northeast-area/beltsville-md/beltsville-human-nutrition-research-center/nutrient-data-laboratory/docs/usda-national-nutrient-database-for-standard-reference/
* PDF source:  https://www.ars.usda.gov/ARSUserFiles/80400525/Data/SR/SR28/sr28_doc.pdf

* https://ndb.nal.usda.gov/ndb/

* SEARCH: https://ndb.nal.usda.gov/ndb/search/list
...
* Rename .txt to .csv
* Open in OpenOffice
* Get the correct row and string delimiters ^ and ~
* Save as ODS
* Resave in csv
...
* Start Mongo console and mongod daemon
* Start another Mongo console to type in commands:

```
mongoimport -d nhq -c FOOD_DES --type csv --file D:\WEBDEV\react\nutritionhq\src\data\FOOD_DES.csv --headerline
mongoimport -d nhq -c NUT_DATA --type csv --file D:\WEBDEV\react\nutritionhq\src\data\NUT_DATA.csv --headerline
mongoimport -d nhq -c NUTR_DEF --type csv --file D:\WEBDEV\react\nutritionhq\src\data\NUTR_DEF.csv --headerline
mongoimport -d nhq -c FD_GROUP --type csv --file D:\WEBDEV\react\nutritionhq\src\data\FD_GROUP.csv --headerline
```
